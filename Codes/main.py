...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.AddNewGroupButton = QtWidgets.QPushButton(self.verticalLayoutWidget)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.tablo.verticalHeaderItem(1)
        item.setText(_translate("MainWindow", "2"))
        item = self.tablo.verticalHeaderItem(2)
        item.setText(_translate("MainWindow", "3"))
        item = self.tablo.verticalHeaderItem(3)
        item.setText(_translate("MainWindow", "4"))
        item = self.tablo.verticalHeaderItem(4)
        item.setText(_translate("MainWindow", "5"))
        item = self.tablo.verticalHeaderItem(5)
